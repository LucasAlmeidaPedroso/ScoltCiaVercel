...
Depois de rodar o SQL do Supabase, o usuario admin principal ja fica criado no banco:
...
Se precisar resetar ou criar outro admin por script, configure as variaveis localmente:
